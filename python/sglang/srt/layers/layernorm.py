...
if _is_cuda or _is_xpu:
    ...
    # HIP: use sgl_kernel norm ops (ROCm build registers rmsnorm, gemma_rmsnorm, etc.)
    from sgl_kernel import (
        fused_add_rmsnorm,
        gemma_fused_add_rmsnorm,
        gemma_rmsnorm,
...
class GemmaRMSNorm(MultiPlatformOp):
    ...
    def _forward_impl(
        ...
        # HIP/CUDA kernel requires contiguous input (e.g. Q/K norm path may pass reshaped views)
